 ...
 */
public class MyHelpLabel extends JLabel{
    ...
    public MyHelpLabel(JComponent c1, JComponent c2, String text, int position, int width){
        ...
        switch(position) {
            ...
            case ORIENTATION_LEFT:
                setText("<html><table><tr>"
                        + "<td width='50' valign='middle'><hr/></td>"
                        + "<td width='"+Integer.toString(width)+"'>"+text+"</td>"
                        + "</tr></table></html>");
                break;
